...
blast_results <- read_tsv("/data/rds/DMP/UCEC/EVOLIMMU/csalas_rds/gaurav_rds/virnatrap/output/metagenomics/cov_analysis/FUNGI_coverage_hits.tsv") %>%
  dplyr::select(
    Sample,
    QueryID,
    SubjectID,
...
write.csv(carcinogen_hits, "all_carcinogenic_fungi.csv", row.names = FALSE)
...
final_plot <- (main_plot | conf_plot) +
  plot_annotation(
    title = "Comprehensive Fungi-Cancer (Mycotoxin) Association Analysis",
...
tryCatch({
  ggsave(
    "comprehensive_fungi_cancer_analysis.png",
    plot = final_plot,
  ...
  png("comprehensive_fungi_cancer_analysis.png", width = 1600, height = 1000)
  print(final_plot)
  dev.off()
  message("Used alternative save method - check comprehensive_fungi_cancer_analysis.png")
})
...
blast_results <- read_tsv("/data/rds/DMP/UCEC/EVOLIMMU/csalas_rds/gaurav_rds/virnatrap/output/metagenomics/cov_analysis/BACT_coverage_hits.tsv") %>%
  dplyr::select(
    Sample,
    QueryID,
    SubjectID,
...
# 4. Generate and save summary reports
write.csv(carcinogen_hits, "all_carcinogenic_bacteria.csv", row.names = FALSE)
...
final_plot <- (main_plot | conf_plot) +
  plot_annotation(
    title = "Comprehensive Bacteria-Cancer Association Analysis",
    subtitle = "Showing relationships, evidence, and occurrence counts",
    theme = theme(
      plot.title = element_text(size = 16, face = "bold"),
      plot.subtitle = element_text(size = 12)
...
tryCatch({
  ggsave(
    "comprehensive_bacteria_cancer_analysis.png",
    plot = final_plot,
  ...
  message("Error saving plot: ", e$message)
  png("comprehensive_bacteria_cancer_analysis.png", width = 1600, height = 1000)
  print(final_plot)
  dev.off()
  message("Used alternative save method - check comprehensive_bacteria_cancer_analysis.png")
})
...
blast_results <- read_tsv("/data/rds/DMP/UCEC/EVOLIMMU/csalas_rds/gaurav_rds/virnatrap/output/metagenomics/cov_analysis/VIRUS_coverage_hits.tsv") %>%
  dplyr::select(
    Sample,
    QueryID,
    SubjectID,
...
# 4. Generate and save summary reports
write.csv(carcinogen_hits, "all_carcinogenic_viruses.csv", row.names = FALSE)
...
final_plot <- (main_plot | conf_plot) +
  plot_annotation(
    title = "Comprehensive Virus-Cancer Association Analysis",
    subtitle = "Showing relationships, evidence, and occurrence counts",
    theme = theme(
      plot.title = element_text(size = 16, face = "bold"),
      plot.subtitle = element_text(size = 12)
...
tryCatch({
  ggsave(
    "comprehensive_virus_cancer_analysis.png",
    plot = final_plot,
    width = 16, height = 10, dpi = 300
  )
  message("Successfully saved combined plot!")
  ...
  message("Error saving plot: ", e$message)
  png("comprehensive_virus_cancer_analysis.png", width = 1600, height = 1000)
  print(final_plot)
  dev.off()
  message("Used alternative save method - check comprehensive_virus_cancer_analysis.png")
})
...
blast_results <- read_tsv("/data/rds/DMP/UCEC/EVOLIMMU/csalas_rds/gaurav_rds/virnatrap/output/metagenomics/cov_analysis/PARASITE_coverage_hits.tsv") %>%
  dplyr::select(
    Sample,
    QueryID,
    SubjectID,
...
# 4. Generate and save summary reports
write.csv(carcinogen_hits, "all_carcinogenic_parasites.csv", row.names = FALSE)
...
final_plot <- (main_plot | conf_plot) +
  plot_annotation(
    title = "Comprehensive Parasite-Cancer Association Analysis",
    subtitle = "Showing relationships, evidence, and occurrence counts",
    theme = theme(
      plot.title = element_text(size = 16, face = "bold"),
      plot.subtitle = element_text(size = 12)
...
tryCatch({
  ggsave(
    "comprehensive_parasite_cancer_analysis.png",
    plot = final_plot,
    width = 16, height = 10, dpi = 300
  )
  message("Successfully saved combined plot!")
  ...
  message("Error saving plot: ", e$message)
  png("comprehensive_parasite_cancer_analysis.png", width = 1600, height = 1000)
  print(final_plot)
  dev.off()
  message("Used alternative save method - check comprehensive_parasite_cancer_analysis.png")
})
